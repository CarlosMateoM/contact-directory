...
import contact.directory.view.model.CiudadTableModel;
...
public class CityForm extends javax.swing.JPanel {
    ...
    private CommuneForm comunaForm;
    private CiudadTableModel tablaCiudad;
    private CityController ciudadController;
    ...
    private void init() {
        ...
        selectionModel.addListSelectionListener((ListSelectionEvent e) -> {
            if (!e.getValueIsAdjusting()) {
                ...
                if (selectedRow >= 0) {
                    try {
                        City ciudad = tablaCiudad.getListaCiudades().get(selectedRow);
    ...
    public void setComunaForm(CommuneForm comunaForm) {
        this.comunaForm = comunaForm;
    }

    public void setCiudadController(CityController ciudadController) {
        this.ciudadController = ciudadController;
    }

    public void updateCitiesList(List<City> cities) {
        SwingUtilities.invokeLater(() -> {
            tablaCiudad.setListaCiudades(cities);
        });
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        City ciudad = tablaCiudad.getListaCiudades().get(index);
        String response = ciudadController.deleteCity(ciudad);
        javax.swing.JOptionPane.showMessageDialog(null, response);
